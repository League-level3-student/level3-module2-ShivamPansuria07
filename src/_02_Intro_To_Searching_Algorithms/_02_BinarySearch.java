...
public class _02_BinarySearch {
	/*
	 * Binary searches are good for sorted data because it can potentially take a
	 * lot less time than a linear search, especially if the data set is very large.
	 * But it cannot be used for unsorted lists.
	 *
	 * Because binary search is a recursive algorithm, the binarySearch method will
	 * take in two extra integer parameters to define the start and end position of
	 * the search.
	 */
